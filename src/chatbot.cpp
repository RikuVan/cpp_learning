...
ChatBot::ChatBot(const ChatBot &other) // copy constructor
{
    ...
    std::cout << "COPY CONSTRUCTOR: COPYING content of instance " << &other << " to instance " << this << std::endl;
}

ChatBot::ChatBot(ChatBot &&other) // move constructor
{
    std::cout << "MOVE CONSTRUCTOR: MOVING (assign) instance " << &other << " to instance " << this << std::endl;
    if (this != &other) {
        _image = other._image;
